...
Natural language question answering on academic topics
Context-aware responses suited to a classroom setting
Support for both student queries and instructor use cases
Clean and accessible conversational interface

Technologies Used

Python
Natural Language Processing (NLP)
Conversational AI / Language Model integration

Purpose
This project was developed as part of an academic exploration into the use of AI in education. It demonstrates how intelligent assistants can be integrated into learning environments to improve engagement and accessibility.
